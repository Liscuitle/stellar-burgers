import { TIngredient } from "../../utils/data-types";
...
export const totalTodaySelector = (store: RootState) =>
  store.wsOrders.totalToday;
export const userOrdersSelector = (store: RootState) =>
  store.wsUserOrders.orders;
