...
import IngredientConstructor from "../ingredient-constructor/ingredient-editor";
import {
  burgerConstructorSelector,
  orderTotalSelector,
  userSelector,
} from "../../../services/operations/selector-utils";
import { useAppDispatch, useAppSelector, TFromLocation, TIngredient, TIngredientConstructor } from "../../../utils/data-types";
import { addFilling, clearConstructor, removeFillingElement, setBun } from "../../../services/reducers/constructor-slice";
import { fetchOrder } from "../../../services/reducers/order-manager-slice";
...
export default function BurgerBuilder() {
  ...
  const isEmptyConstructor = !burgerConstructor.bun && burgerConstructor.filling.length === 0;

  return (
    <section className={clsx(styles.section, "mt-25 ml-4")}>
      <div className={clsx(styles.container, isDropIngredient ? styles.dragging : "")} ref={dropRefIngredient}>
        <div className={"ml-8"}>
