...
import { fetchLogIn } from "../../../services/reducers/authentication-slice";
import { TUserLogIn, useAppDispatch } from "../../../utils/data-types";
  ...
  return (
    <section className={styles.container}>
      ...
      <div className={clsx(styles.linkBlock, "mt-20")}>
        ...
        <Link to="/register" className={clsx(styles.link, "text text_type_main-default")}>Зарегистрироваться</Link>
      </div>
      <div className={clsx(styles.linkBlock, "mt-4")}>
        <p className="text text_type_main-default">Забыли пароль?</p>
        <Link to="/forgot-password" className={clsx(styles.link, "text text_type_main-default")}>Восстановить пароль</Link>
      </div>
    </section>
  );
}
